...
All required dependencies are already specified. Make sure you have `npm` and `create-react-app` packages installed on your machine.

## What's Included

The `_DATA.js` file represents a fake database and methods that let app access the data.
...
This code will be talking to the database via 4 methods:
...
This repository only contains the project submitted by me for [Udacity's React & Redux course](https://www.udacity.com/course/react-nanodegree--nd019). Therefore, no contributions are required.